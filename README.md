...
I told Codex to go liberal on the inline comments and produce human-readable code. Rather than starting with a vague overall blueprint, I had Codex build this piece-by-piece as if I were doing it manually. Because of this I was able to keep track of what the machine was doing, and force it to adhere to my [minimalist philosophy](https://bestpoint.institute/tactics/unix-philosophy) & workflow as best as I could.

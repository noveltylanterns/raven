...
- Fixed SQLite update safety for fresh installs by preserving the configured SQLite base path during panel updater cleans and moving the installer default SQLite storage path to `private/dat/db/`.

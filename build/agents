...
- Hand-authored docs (`docs/API.md`, `docs/Introduction.md`, narrative docs, `docs/extensions/`) are fair game to edit directly and should be kept in sync with codebase changes as normal.
...
3) When `private/bin/` CLI commands are added or changed:
  ...
  - Keep CLI command documentation synchronized in `docs/CLI.md`.

...
final class ReferenceGenerator
{
    ...
    private function bootstrapOutputs(): array
    {
        ...
        $lines = [];
        $lines[] = '# Bootstrap Appendix Reference';
        $lines[] = '';
    ...
    private function cliOutputs(): array
    {
        ...
        foreach ($slugs as $slug) {
            $binaryPath = $this->root . '/private/bin/rvn-' . $slug;
            $command = [PHP_BINARY, $binaryPath, '--no-banner', '--help'];
            ...
            $status = $result['exit'] === 0 ? 'ok' : 'error';
            $overviewRows[] = '- `' . $slug . '` -> `' . $status . '` -> `docs/appendix/cli/' . $slug . '.md`';

            $body = '# CLI Command Reference: ' . $slug . "\n\n"
                . '_Generated by `php build/docs/rvn-docs.php`. Do not edit this file by hand._' . "\n\n"
                . '## Command' . "\n\n"
                . '`php private/bin/rvn-' . $slug . ' --no-banner --help`' . "\n\n"
                . '## Exit Code' . "\n\n"
                . (string) $result['exit'] . "\n\n"
                . '## Help Output' . "\n\n"
                . "```text\n" . rtrim($helpOutput, "\n") . "\n```\n";
        ...
        $overview = '# CLI Appendix Overview' . "\n\n"
            . '_Generated by `php build/docs/rvn-docs.php`. Do not edit this file by hand._' . "\n\n"
    ...
    private function configOutputs(): array
    {
        ...
        $lines = [];
        $lines[] = '# Config Appendix Reference';
        $lines[] = '';
        $lines[] = '_Generated by `php build/docs/rvn-docs.php`. Do not edit this file by hand._';
        $lines[] = '';
        $lines[] = '## Sources';
    ...
    /**
     * Discovers command slugs from executable `private/bin/rvn-*` wrappers.
     *
     * @return array<int, string> Stable, alphabetized list of command slugs.
     */
    ...
    private function databaseOutputs(): array
    {
        ...
        $lines = [];
        $lines[] = '# Database Appendix Reference';
        $lines[] = '';
        $lines[] = '_Generated by `php build/docs/rvn-docs.php`. Do not edit this file by hand._';
        $lines[] = '';
        $lines[] = '## Sources';

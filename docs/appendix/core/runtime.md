...
- File: `private/sys/Runtime/Panel/ControllerFactory.php`
- Service Keys: `panel_request_context`, `root`
- Params: `(none)`
...
- File: `private/sys/Runtime/Panel/ControllerFactory.php`
- Service Keys: `auth_controller`, `config`, `csrf`, `input`, `panel_docs_controller`, `panel_permission_map_provider`, `panel_request_context`, `root`, `view`
- Params:

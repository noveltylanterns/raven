...
- Params:
  ...
  - `ChannelRead $channelRead Channel repository read side for parent-aware channel prefilter resolution.`
...
- Params:
  - `SharedController $context Shared public request context.`
  - `ChannelRead $channelRead Channel repository read side for parent-aware public paths.`
...
- Params:
  ...
  - `string|null $channelSlug Optional slash-separated parent channel path.`

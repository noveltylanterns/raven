...
- File: `private/sys/Controller/Panel/DocsController.php`
- Service Keys: `(none)`
- Params:
  - `SharedController $context Shared panel request context and wrapper renderer.`
  - `string $projectRoot Absolute Raven project root containing the canonical docs/ tree.`

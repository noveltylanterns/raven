...
| `Raven\Core\Schema\SchemaBootstrap::__construct()` | `method` | Accepts an optional introspector used for legacy-table rename checks. | (No @return.) | `(none)` |
...
### `Raven\Core\Schema\SchemaBootstrap::__construct()`

- File: `private/sys/Schema/SchemaBootstrap.php`
- Service Keys: `(none)`
- Params:
  - `SchemaIntrospector|null $introspector Cross-driver schema inspection helper; defaults to a fresh instance.`

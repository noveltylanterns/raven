...
- destructive-guard behavior (stock group delete blocked, protected stock extensions such as `contact`, `cron`, `database`, `phpinfo`, `repo`, `signups`, and `smallweb` blocked from uninstall, active-theme uninstall blocked)

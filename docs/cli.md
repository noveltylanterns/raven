...
- destructive-guard behavior (stock group delete blocked, protected stock extensions such as `contact`, `cron`, `database`, `phpinfo`, `repo`, and `signups` blocked from uninstall, active-theme uninstall blocked)

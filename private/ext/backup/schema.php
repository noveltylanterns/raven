 ...
 * Backup & Restore extension schema provider.
...
return static function (array $context): void {
    ...
    $tableResolver = $context['table'];   // returns `{prefix}ext_backup`
    $tablesResolver = $context['tables']; // returns `{prefix}ext_backup_{suffix}`

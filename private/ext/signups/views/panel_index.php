...
/**
 * RAVEN CMS
 * ~/private/ext/signups/views/panel_index.php
 * Signup Sheets extension list page template with CRUD actions.
...
<div class="card">
    <div class="card-body">
        ...
        <?php if ($forms === []): ?>
            <p class="text-muted mb-0">No signup sheet forms are configured.</p>
        <?php else: ?>
                        ...
                        >
                            ...
                            <td class="text-center">
                                <div class="d-inline-flex gap-2">
                                    <a href="<?= e($signupsBasePath) ?>/<?= rawurlencode($slug) ?>" class="btn btn-success btn-sm">View Submissions</a>
                                    <a

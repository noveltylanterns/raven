...
/**
 * RAVEN CMS
 * ~/private/ext/signups/views/panel_edit.php
...
<form method="post" action="<?= e($formAction) ?>">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="mb-3">
                <label class="form-label h5" for="signups_form_slug">Slug</label>
                <input
                        ...
                        <div class="border rounded p-2 mb-2" data-signups-additional-row="1">
                            <div class="row g-2 align-items-end">
                                ...
                                <div class="col-md-2 d-flex align-items-center justify-content-between gap-2">
                                    ...
                                    <button type="button" class="btn btn-secondary btn-sm" data-signups-remove-field="1">Remove</button>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
...
<template id="signups-additional-field-template">
    <div class="border rounded p-2 mb-2" data-signups-additional-row="1">
        <div class="row g-2 align-items-end">
            ...
            <div class="col-md-2 d-flex align-items-center justify-content-between gap-2">
                <div class="form-check mb-0">
                    <input class="form-check-input" type="checkbox" value="1" data-signups-field-key="required">
                    <label class="form-check-label">Required</label>
                </div>
                <button type="button" class="btn btn-secondary btn-sm" data-signups-remove-field="1">Remove</button>
            </div>

...
/**
 * RAVEN CMS
 * ~/private/ext/contact/vis/panel_edit.php
...
<form method="post" action="<?= e($formAction) ?>">
    ...
    <section class="card">
        <div class="card-body">
            ...
            <div class="mb-3">
                <label class="form-label" for="contact_form_slug">Slug</label>
                <input
    ...
    <section class="card">
        <div class="card-body">
            ...
            <div class="mb-3">
                <label class="form-label" for="contact_form_destination">Destination Email(s)</label>
                <input
            ...
            <div class="mb-3">
                <label class="form-label" for="contact_form_cc">CC Email(s)</label>
                <input
                    id="contact_form_cc"
                    type="text"
                    class="form-control"
            ...
            <div class="mb-3">
                <label class="form-label" for="contact_form_bcc">BCC Email(s)</label>
                <input
                    id="contact_form_bcc"
                    type="text"
                    class="form-control"
                    ...
                    <?php foreach ($additionalFields as $index => $additionalField): ?>
                        ...
                        <div class="border rounded p-2 mb-2" data-contact-additional-row="1">
                            <div class="row g-2 align-items-end">
                                ...
                                <div class="col-12<?= $showOptionsForType ? '' : ' d-none' ?>" data-contact-field-options-wrap="1">
                                    <label class="form-label">Options</label>
                                    <textarea
                                        class="form-control"
                                        data-contact-field-key="options"
    ...
    <div class="border rounded p-2 mb-2" data-contact-additional-row="1">
        <div class="row g-2 align-items-end">
            <div class="col-md-4">
                ...
                <div class="input-group">
                    <span class="input-group-text gap-2">
                        <input class="form-check-input mt-0" type="checkbox" value="1" data-contact-field-key="required" aria-label="Required">
                        <span class="small">Required</span>
                    </span>
            ...
            <div class="col-12 d-none" data-contact-field-options-wrap="1">
                <label class="form-label">Options</label>
                <textarea
                    class="form-control"
                    data-contact-field-key="options"

...
/**
 * RAVEN CMS
 * ~/private/ext/contact/tpl/panel_submissions.php
    ...
    <div class="card-body">
        <div class="row g-2 mb-3">
            <div class="col-12 col-lg-8">
                <label class="form-label mb-1" for="<?= e($submissionsSearchId) ?>">Search</label>
                <input
                                    ...
                                    <div class="p-3 mb-0 border-bottom">
                                        <div class="row g-3">
                                            <div class="col-12 col-xl-6">
                                                <h5>Full Message</h5>
                                                <?php if ($messageText === ''): ?>
                                                    <p class="text-muted mb-3">No message body provided.</p>
                                                <?php else: ?>
                                                    <div class="small mb-3" style="white-space: pre-wrap;"><?= e($messageText) ?></div>
                                                <?php endif; ?>

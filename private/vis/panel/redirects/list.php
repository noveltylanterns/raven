        ...
        <?php else: ?>
            <div class="row g-2 mb-3">
                <div class="col-12 col-lg-6">
                    <label class="form-label mb-1" for="<?= e($redirectsSearchId) ?>">Search</label>
                    <input
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <label class="form-label mb-1" for="<?= e($redirectsStatusSortId) ?>">Sort by Status</label>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <label class="form-label mb-1" for="<?= e($redirectsChannelSortId) ?>">Sort by Channel</label>

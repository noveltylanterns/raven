...
$textEditorOverride = strtolower(trim((string) ($channel['text_editor_override'] ?? 'inherit')));
...
<form method="post" action="<?= e($panelBase) ?>/channels/save" enctype="multipart/form-data">
    ...
    <div class="tab-content raven-tab-content-surface border border-top-0 p-3" id="rvnp-editor-content">
        ...
        >
            <div class="form-group">
                <label for="text_editor_override" class="form-label">Default Text Editor Override</label>
                <select id="text_editor_override" name="text_editor_override" class="form-select">
                    <option value="inherit"<?= $textEditorOverride === 'inherit' ? ' selected' : '' ?>>Use Global Default</option>
                    <option value="tinymce"<?= $textEditorOverride === 'tinymce' ? ' selected' : '' ?>>Rich Text (TinyMCE)</option>
                    <option value="plaintext"<?= $textEditorOverride === 'plaintext' ? ' selected' : '' ?>>Plaintext</option>
                    <option value="autobr"<?= $textEditorOverride === 'autobr' ? ' selected' : '' ?>>Auto &lt;br&gt;</option>
                    <option value="markdown"<?= $textEditorOverride === 'markdown' ? ' selected' : '' ?>>Markdown</option>
                </select>
                <div class="form-text">
            ...
            <div class="form-group mb-0 mt-3">
                <label class="form-label d-block">Page URL Separator</label>
                <div class="form-check">
                    <input
                        class="form-check-input"
                        type="radio"
                        name="page_url_separator"
                        id="page_url_separator_inherit"
                        value="inherit"
                        <?= $pageUrlSeparator === 'inherit' ? 'checked' : '' ?>
                    >
                    <label class="form-check-label" for="page_url_separator_inherit">Use Global Default</label>
                </div>
                <div class="form-check">
                    <input
                        class="form-check-input"
                        type="radio"
                        name="page_url_separator"
                        id="page_url_separator_dash"
                        value="-"
                        <?= $pageUrlSeparator === '-' ? 'checked' : '' ?>
                    >
                    <label class="form-check-label" for="page_url_separator_dash">- (Hyphen)</label>
                </div>
                <div class="form-check">
                    <input
                        class="form-check-input"
                        type="radio"
                        name="page_url_separator"
                        id="page_url_separator_underscore"
                        value="_"
                        <?= $pageUrlSeparator === '_' ? 'checked' : '' ?>
                    >
                    <label class="form-check-label" for="page_url_separator_underscore">_ (Underscore)</label>
                </div>
            </div>
        </div>

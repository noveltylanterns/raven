    ...
    <div class="col-6 col-md-3">
        <div class="card h-100">
            <div class="card-body">
                ...
                <div class="h3 mb-0"><?= $conflictCount ?></div>
        ...
        <?php else: ?>
            <div class="row g-2 mb-3">
                <div class="col-12 col-md-8">
                    <label class="form-label mb-0" for="routing-filter-search">Search</label>
                    <input
                ...
                <div class="col-12 col-md-4">
                    <label class="form-label mb-0" for="routing-filter-status">Status</label>
                ...
                <div class="col-12">
                    <span class="form-label mb-0 d-inline-block">Types</span>

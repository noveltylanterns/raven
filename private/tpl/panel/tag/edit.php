 ...
 * Admin panel tag edit/create template.
...
<form id="<?= e($deleteFormId) ?>" method="post" action="<?= e($panelBase) ?>/tag/delete">
    <?= $csrfField ?>

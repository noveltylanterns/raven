...
$defaultPageUrlSeparator = in_array($defaultPageUrlSeparator ?? '-', ['-', '_'], true)
    ? (string) $defaultPageUrlSeparator
    : '-';
...
foreach ($channelOptions as $channelOption) {
    ...
    $override = strtolower(trim((string) ($channelOption['text_editor_override'] ?? 'inherit')));
    ...
    $urlSeparator = trim((string) ($channelOption['page_url_separator'] ?? 'inherit'));
                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-2">
                            ...
                            <div class="d-flex flex-wrap align-items-center gap-2">
                                <button
                                    ...
                                    data-rvn-site-default-text-editor="<?= e($defaultTextEditor) ?>"
                    ...
                    <div class="form-group">
                        ...
                        <select id="channel_slug" name="channel_slug" class="form-select">
                            ...
                            <?php foreach ($channelOptions as $channel): ?>
                                ...
                                <?php
                                $channelEditorOverride = strtolower(trim((string) ($channel['text_editor_override'] ?? 'inherit')));
                                ...
                                <option
                                    value="<?= e($slug) ?>"
                                    data-rvn-channel-text-editor-override="<?= e($channelEditorOverride) ?>"
                                    data-rvn-channel-page-route-mode="<?= e($channelRouteMode) ?>"
                                    data-rvn-channel-page-url-separator="<?= e($channelUrlSeparator) ?>"
...
<script>
  ...
  (function () {
    ...
    function resolvePreferredTextEditor() {
      ...
      var siteDefaultEditor = normalizeBodyBlockType(addTextButton.getAttribute('data-rvn-site-default-text-editor') || 'tinymce');
      if (!(channelSelect instanceof HTMLSelectElement)) {
        return siteDefaultEditor;
      }
      ...
      var override = String(selectedOption.getAttribute('data-rvn-channel-text-editor-override') || 'inherit').toLowerCase().trim();
      if (override === 'inherit') {
        return siteDefaultEditor;
      }

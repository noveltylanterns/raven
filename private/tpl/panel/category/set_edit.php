...
/**
 * RAVEN CMS
 * ~/private/tpl/panel/category/set_edit.php
 * Admin panel category-set edit template.
    ...
    <section class="card">
        <div class="card-body">
            <div class="form-group">
                ...
                <div class="form-text">Display name for this category set in taxonomy controls.</div>
                <?php if ($isDefaultSet): ?>
            ...
            <div class="form-group">
                ...
                <?php else: ?>
                    <div class="form-text">Canonical slug used to distinguish this category set.</div>
                <?php endif; ?>
            </div>
            ...
            <div class="form-group mb-0">
                ...
                <div class="form-text">Optional editorial description for this category set.</div>
                <?php if ($isDefaultSet): ?>

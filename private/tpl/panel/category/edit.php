 ...
 * Admin panel category edit/create template.
...
$deleteFormId = 'delete-category-form';
$coverPath = trim((string) ($category['cover_image_path'] ?? ''));
$previewPath = trim((string) ($category['preview_image_path'] ?? ''));
$iconPath = trim((string) ($category['icon_image_path'] ?? ''));
...
<form id="<?= e($deleteFormId) ?>" method="post" action="<?= e($panelBase) ?>/category/delete">
    <?= $csrfField ?>
...
<form method="post" action="<?= e($panelBase) ?>/category/save" enctype="multipart/form-data">
    ...
    <div class="tab-content raven-tab-content-surface border border-top-0 p-3" id="rvnp-editor-content">
        <div
            ...
            role="tabpanel"
            aria-labelledby="category-basic-tab"
            tabindex="0"
        >
        ...
        <div
            ...
            role="tabpanel"
            aria-labelledby="category-media-tab"
            tabindex="0"
        >

...
$paginationBasePath = (string) ($pagination['base_path'] ?? ($panelBase . '/group'));
        ...
        <?php else: ?>
            <div class="row g-2 mb-3">
                <div class="col-12 col-md-8">
                    <label class="form-label mb-1" for="<?= e($groupsSearchId) ?>">Search</label>
                    <input
                        id="<?= e($groupsSearchId) ?>"
                        type="search"
                ...
                <div class="col-12 col-md-4">
                    <label class="form-label mb-1" for="<?= e($groupsTypeFilterId) ?>">Type</label>

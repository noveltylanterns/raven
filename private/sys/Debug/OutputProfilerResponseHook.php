...
/**
 * RAVEN CMS
 * ~/private/sys/Debug/OutputProfilerResponseHook.php
 ...
 */
final class OutputProfilerResponseHook
{
    /**
    ...
    public static function arm(
        ...
        ob_start(static function (string $body) use ($settings, $scope, $requestMethod, $requestPath, $canRenderProfiler): string {
            if (!RequestProfiler::isEnabled() || !OutputProfilerRenderer::isHtmlResponseCandidate($body)) {
                return $body;
            }
            ...
            $profilerHtml = OutputProfilerRenderer::render(
                [
            ...
            return OutputProfilerRenderer::inject($body, $profilerHtml);
        });
    }
}

...
final class Response
{
    ...
    /**
     * Constructs a handled response with matched parameters and a handler response.
     *
     * @param array<string, string> $params Named path parameters from the matched route.
     * @param mixed $response Response value returned by the route handler.
     * @return self Handled response instance.
     */
    ...
    /**
     * Constructs an unhandled response for requests that matched no registered route.
     *
     * @return self Unhandled response instance.
     */

...
/**
 * RAVEN CMS
 * ~/private/sys/Routing/Public/PrefixedSlugPageRouter.php
 ...
 */
final class PrefixedSlugPageRouter
{
    /**
     ...
     *
     * @param Router $router Mutable router receiving the prefix routes.
    ...
    public static function register(
        ...
        $router->add('GET', $base . '/{slug}/{page}', static function (array $params) use ($onSlugPage, $publicRequestContext, $input): void {
            ...
            $slug = RouteParamGuard::slugOrNotFound($input, $params['slug'] ?? null, $notFound);
            $page = RouteParamGuard::intOrNotFound($input, $params['page'] ?? null, 1, $notFound);

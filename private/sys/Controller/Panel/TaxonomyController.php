 ...
 * Split panel taxonomy controller for redirect routes.
...
/**
 * Handles split taxonomy-management routes.
 *
 * Redirect CRUD is the first taxonomy slice extracted from the legacy
 * monolithic PanelController; channel/category/tag routes will follow.
 */
